...
const callPerplexity = async (prompt, maxTokens = 2048, useResearch = false) => {
  // Use Sonar Pro for all queries (supports web search)
  // Try different model name formats based on API version
  const model = 'sonar';  // Sonar base model with web search
